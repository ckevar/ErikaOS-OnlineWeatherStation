...
char OWAPI_get_weather(char *json, char **vals, unsigned short *vals_len) {
	char *keys[OWAPI_PARAMS_COUNT] = {OWAPI_TIMEZONE, OWAPI_TIME, 
        OWAPI_FEELS_LIKE, OWAPI_TEMP, OWAPI_ICON, OWAPI_DESCRIPTION};

	unsigned short keys_sizes[OWAPI_PARAMS_COUNT] = {OWAPI_TIMEZONE_LEN,
	...
	json_query_mulKey_ValPtrLen(json, OWAPI_PARAMS_COUNT, keys,\
									keys_sizes, vals, vals_len);
